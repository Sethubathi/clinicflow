...
if (isset($_POST["btn_purchase_code"])) {
    ...
    $_SESSION["license_code"] = $_POST['purchase_code'];
    $_SESSION["license"] = 'extended';
    $_SESSION["sold_at"] = date("Y-m-d",strtotime('2022-10-10'));
                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="purchase_code" class="form-control form-input" style="resize: vertical; height: 80px;line-height: 24px;padding: 10px;" placeholder="Enter random data" required></textarea>
                                            </div>
